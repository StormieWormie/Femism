...
int main(int argc, char** argv){
    ...
    if(argc>3){
        ...
        GLOBAL_a = std::atof(argv[5]);
        GLOBAL_b = std::atof(argv[6]);
        GLOBAL_c0 = std::atof(argv[7]);
        GLOBAL_c1 = std::atof(argv[8]);
        GLOBAL_d0 = std::atof(argv[9]);
        GLOBAL_d1 = std::atof(argv[10]);
        GLOBAL_e = std::atof(argv[11]);
        GLOBAL_e0 = std::atof(argv[12]);
        GLOBAL_e1 = std::atof(argv[13]);
